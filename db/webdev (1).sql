...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2025 at 02:01 AM
...
CREATE TABLE `notifications` (
  ...
  `type` enum('info','success','warning','error','reminder') DEFAULT NULL,
...
(1, 1, 'This is the title of the notification', 'Here is the content of the notification', 'info', 0, '2025-11-11 00:50:19', NULL);
...
INSERT INTO `quiz_answers` (`id`, `submission_id`, `question_id`, `user_choice`, `is_correct`, `answered_at`) VALUES
(5, 4, 1, 'B', 1, '2025-11-10 20:46:51'),
(6, 4, 2, 'B', 0, '2025-11-10 20:46:51');
...
(2, 1, 'What is the most popular Code Editor?', 'Atom', 'Sublime Text', 'VS Code', 'Notepad++', 'C', 'VS Code is the most used Code Editor in the world');
...
INSERT INTO `quiz_submissions` (`user_id`, `lecture_id`, `submission_time`, `answers`, `score`, `id`) VALUES
(1, 1, '2025-11-10 20:46:51', '', 50, 4);
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `reset_token_hash`, `reset_token_expires`) VALUES
(1, 'Mukhiteee', 'mukhiteee@gmail.com', '$2y$10$G6NHGSJ59d9LUMOEH7P2xOjiokzrkxLxCaCwf4zwjeTs78H105wj2', NULL, NULL),
(2, 'Sadiq Ibrahim', 'Sadiqabdulhamid@gmail.com', '$2y$10$GrtdL2HatIjxbdzEMRGyZeqhNYgXrWvFLt5.BVo9sihAUyuBnYVA6', NULL, NULL),
(3, 'Abdulhamid Rodiya', 'diyah@gmail.com', '$2y$10$/tYPpd5nCISCakhx6CRWIukKcqWYihiNTRCGKLZSqMuJpPzopZ1Cy', NULL, NULL);
